  ...
  head: () => ({
    meta: [
      ...
      { title: "Portal Supervisi Akademik MTs Annur 1" },
      {
        name: "description",
        content:
          "Sistem digital supervisi akademik guru MTs Annur 1 Cinagara, Malangbong, Garut.",
      },
      { name: "author", content: "MTs Annur 1" },
      { property: "og:title", content: "Portal Supervisi Akademik MTs Annur 1" },
      {
        property: "og:description",
        content: "Sistem digital supervisi akademik guru MTs Annur 1.",
      },
